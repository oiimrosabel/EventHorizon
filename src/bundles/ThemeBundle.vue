  ...
  <OverlayMenu @hide="$emit('hide')">
    ...
    <ButtonsList>
      <TextButton @click="themeService.switchTheme(themeNames.SYSTEM)">
        <img alt="System" src="/icons/system.png" />
        <p>Système</p>
      </TextButton>
